<?php
class PostHasPlataformaModel extends Model
{
    private $idPost;
    ...
    public function setPlataformaId($id)
    {
    ...
    {
        try {
            $query = $this->prepare('INSERT INTO post_has_plataformas (post_id, plataformas_id) VALUE(:post_id, :plataforma_id)');
            $query->execute([
                'post_id' => $this->idPost,
                'plataforma_id' => $this->idPlataforma
            ]);
    ...
    public function from($array)
    {
        ...
        $this->idPlataforma = $array['plataformas_id'];
